      ...
      {paymentType === 'payment1' ? (
        ...
        <TextField
          ...
          value={(() => {
            ...
            date.setFullYear(2025); // เปลี่ยนปีเป็น 2025
            const day = String(date.getDate()).padStart(2, "0"); // แปลงเป็น 2 หลัก
            const month = String(date.getMonth() + 1).padStart(2, "0"); // แปลงเป็น 2 หลัก (มกราคม = 0)
            const year = date.getFullYear(); // ปี ค.ศ.
            return `${day}/${month}/${year}`; // ฟอร์แมต dd/mm/yyyy
          })()}

...
<div style={{ marginBottom: '20px', display: 'flex', gap: '10px' }}>
                ...
                {filteredMembers
                  ...
                  .map((member) => (
                    <TableRow key={member.id}>
                      ...
                      <TableCell>{new Date(member.startDate).toLocaleDateString('en-GB', { day: '2-digit', month: '2-digit', year: 'numeric' })}</TableCell>
                      <TableCell>{new Date(member.endDate).toLocaleDateString('en-GB', { day: '2-digit', month: '2-digit', year: 'numeric' })}</TableCell>
    ...
    <TableRow key={member.id}>
      ...
      <TableCell>{new Date(member.date).toLocaleDateString('en-GB', { day: '2-digit', month: '2-digit', year: 'numeric' })}</TableCell>
    </TableRow>
  ))}
</TableBody>
